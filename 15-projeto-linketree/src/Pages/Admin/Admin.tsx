            ...
            <form className="flex flex-col mt-8 mb-3 w-full max-w-xl" onSubmit={handleRegister}>
                ...
                <section className="flex my-4 gap-5">
                    <div className="flex gap-2">
                        <label htmlFor="textColorInput" className="text-white font-medium mt-2 mb-2">Cor do link</label>
                        <input
                            id="textColorInput"
                            type="color"
                    ...
                    <div className="flex gap-2">
                        <label htmlFor="backgroundColorInput" className="text-white font-medium mt-2 mb-2">Fundo do link </label>
                        <input
                ...
                </section>
                {
                    nameInput && (
                        <div className="flex items-center justify-start flex-col mb-7 p-1 border-gray-100/25 border rounded-md">
                            <label className="text-white font-medium mt-2 mb-2">Como está ficando o link</label>
                            <article 
                    ...
                    return (
                        ...
                        <div>
                            <button 
                                type="button" 
                                title="trash" 
                                className="border border-dashed p-2 rounded bg-neutral-900"
